...
<script>
    ...
    $(function(){
    	   $("#btnmyinfo").on("click",function(){
    		  ...
    		  passval = '<%=profileVo.getStd_pass()%>'

    	      inputval = $('#upass').val();
    	            if(passval==inputval){
    	               location.href = "updateMyInfo.jsp"
    	            }else{
    	               alert("비밀번호 오류!!");
    	            }
    	      console.log(passval);
...
<!-- 위에 로고끝 -->
            ...
            <div class="main-content main-ddit">
               <div class="ddit-content">
              		<input type="password" class="form-control" id="upass" placeholder="비밀번호 입력" name="mempass" style="text-align:center" required>
					           		
					           	 <br><br>
					           	 <input type="button" class="btn btn-primary btn-sm" id="btnmyinfo" value="확인">
